...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        @endif
        <form action="{{ url('obc/update/'.$ctb[0]->id) }}" method="post">
            @csrf
                <div class="row">
                    <div class="col-sm-12 col-md-6 col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="nd_pots"><strong>KETERANGAN :</strong></label>
                                    <textarea id="" cols="30" rows="10" class="form-control form-control-sm border-bottom" disabled>{{ $ctb[0]->keterangan_ctb }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                <div class="col-sm-12 col-md-6 col-xl-6">
                    <div class="form-group">
                        ...
                        <select name="hasil_call" id="hasil_call" class="select2 form-control">
                            ...
                            @foreach ($hasil_caring as $hc)
                                <option value="{{ $hc->id_hasil_caring }}" <?php if($hc->id_hasil_caring == $ctb[0]->hasil_call){echo 'selected';}else{ echo '';} ?> >{{ $hc->hasil_caring }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="pic_obc" id="pic_obc" value="{{ $ctb[0]->pic_obc }}">
                    </div>
                    <div class="form-group">
                        <label for="keterangan_call">KETERANGAN CALL</label>
                        <textarea name="keterangan_call" id="keterangan_call" class="form-control" cols="30" rows="10">{{ $ctb[0]->keterangan_call }}</textarea>
